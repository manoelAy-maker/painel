...
const TEXTOS = {
  pt: {
    ...
    idioma: 'Português',
    titulo: 'Bem-vindo ao',
    descricao: 'Entre com suas credenciais para acessar a plataforma. Um único login dá acesso aos painéis de Estadia e Captação.',
  ...
  en: {
    ...
    idioma: 'English',
    titulo: 'Welcome to',
    descricao: 'Sign in with your credentials to access the platform. One login gives access to Stay Control and Capture panels.',
    ...
    acesso: <>Protected access<br />Operational session</>,
  },
}
  ...
  return (
    <div className="portal-screen min-h-screen flex flex-col bg-[#05070a] text-white font-sans relative overflow-hidden" style={{ fontFamily: "'Inter','Plus Jakarta Sans',Arial,sans-serif" }}>
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-6 py-10">
        <div className={`text-center mb-10 max-w-2xl transition-all duration-1000 ease-out ${heroVisivel ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          <h2 className="text-4xl sm:text-6xl font-bold mb-6 tracking-tight">
            {textos.titulo} <span className="text-blue-500">AYRES</span>
          </h2>
          ...
          <form className="space-y-6" onSubmit={handleLogin}>
            <div>
              ...
              <input
                id="portal-user"
                type="text"
                placeholder={textos.usuarioPlaceholder}
            ...
            <div>
              ...
              <input
                id="portal-pass"
                type="password"
                placeholder={textos.senhaPlaceholder}
      ...
      <div className="fixed bottom-5 right-5 sm:bottom-6 sm:right-7 flex items-center gap-2 text-slate-600 text-[10px] uppercase tracking-widest font-bold opacity-70 hover:opacity-100 transition-opacity">
        {ICONES.lock}
        <span className="text-right leading-tight normal-case tracking-normal">{textos.acesso}</span>
      </div>
